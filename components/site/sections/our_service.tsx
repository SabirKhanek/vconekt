  ...
  return (
    <>
      ...
      >
        ...
        >
          <span className="font-orbit w-fit rounded-3xl bg-primary/15 px-5 py-2 uppercase text-primary">
            Our Services
          </span>
          <p className="heading max-lm:!text-[34px] max-lm:!max-h-full font-orbit my-5 text-[5vw] font-semibold !leading-tight">
        ...
        >
          <div className="flex w-full justify-between gap-6">
            <div className="shrink-0 basis-1/2">
              ...
              <p
                id="presence_text"
                className="font-orbit my-5  font-semibold leading-relaxed md:text-[40px] xl:text-5xl"
              >
                Building Bridges to{' '}
